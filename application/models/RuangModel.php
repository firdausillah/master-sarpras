<?php
 class RuangModel extends CI_Model{
	...
	function __construct()
	{
 	...
 	function get(){
		$this->db->select('tb_ruang.id, id_user, tb_ruang.id_gedung, tb_gedung.nama_gedung, kode_ruang, nama_ruang, tb_ruang.panjang, tb_ruang.lebar, tb_ruang.tinggi, tb_ruang.foto, kondisi');
